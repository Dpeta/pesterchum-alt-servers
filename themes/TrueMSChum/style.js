{"main":
 ...
 {"memoicon": "$path/memo.png",
  ...
  "textarea": { "style": "background: white; font-family: 'Courier'; font-size: 14px;font:bold; border:2px solid #000000;text-align:center; margin-right:10px; margin-left:10px;" },
  "margins": {"top": 0, "bottom": 6, "left": 0, "right": 0 },
  "userlist": { "width": 150,
  ...
  "time": { "text": { "width": 75, 
            ...
            "buttons": { "style": "color: black; font: bold; border: 2px solid #000000; font: bold; font-size: 12px; background: white; margin-top: 5px; margin-right: 5px; margin-left: 5px; padding: 2px; width: 50px;" }, 
